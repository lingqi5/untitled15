...
public class Enemy1 extends Enemy {
    ...
    public Enemy1(MyPanel myPanel) {
        ...
        this.image = Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\enemy1.png");

    }

    //敌机爆炸效果，放在放到数组中
    public Image[] dieImages = new Image[]{
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\enemy1_down1.png"),
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\enemy1_down2.png"),
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\enemy1_down3.png"),
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\enemy1_down4.png"),
    };
