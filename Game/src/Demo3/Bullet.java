...
public class Bullet {
    ...
    public Image[] images = new Image[] {
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\bullet1.png"),
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\bullet2.png"),
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\bullet2.png"),
            Toolkit.getDefaultToolkit().getImage("D:\\zhang\\tupian\\bullet2.png")
    };
    ...
    public void drawSelf(Graphics g) {
        g.drawImage(this.images[imageIndex],x+30,y+30,width,height,null);
        g.drawImage(this.images[imageIndex],x-30,y+30,width,height,null);
